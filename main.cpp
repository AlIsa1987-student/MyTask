...
public:
    ...
    //РњРµС‚РѕРґ (Efremov)
    void pushUP() {
    cout << FIO << " ," << age << " Р»РµС‚ " << "РёР· РіСЂСѓРїРїС‹ " << group << " РѕС‚Р¶РёРјР°РµС‚СЃСЏ" << endl;
    }
};
...
int main() {
    ...
    //РЎРѕР·РґР°РЅРёРµ РѕР±СЉРµРєС‚Р° 4 (Efremov)
    Student student4 ("Р•С„СЂРµРјРѕРІ РќРёРєРёС‚Р°" , 20 , "21318");

    // Р’С‹Р·РѕРІ РјРµС‚РѕРґРѕРІ РґР»СЏ РѕР±СЉРµРєС‚Р° 4
    student4.pullUP();
    student4.pushUP();
    student4.runs();
